           ...
           {   $name_on_ticket =$_POST['name_on_ticket'];
             ...
             /* var_dump($ticketshowid); die;*/
              if(!empty($ticketshowid))
              {
               ...
               $ticket_insert = "INSERT INTO ticket(`name_on_ticket`,`ticket_type`,`type`,purchased_place,cost,ticketshowid,expire_date,node,broker,batch_number,set_link,entitlement,trans_number,print_date,active)
              VALUES ('$name_on_ticket','$ticketpass','$type','$purchase_place','$price','$ticketshowid','$expire_date','$node','$broker','$batchnumber','$set','$entitlement','$trans_no','$print_date','$active')";

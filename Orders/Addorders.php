                     ...
                     if(isset($_POST['orderadd']))

                      {
                       ...
                       /* var_dump($ticket_order);die;*/
                        ...
                        $order_insert="INSERT INTO `order`(`order_id`,`ticket_id`,`ticket_type`, `customer_id`,`customer`, `date_of_visit`,`time`,`option`, `price`,`no_of_days`, `adults`, `kids`,`discount`, `total`,`create_time`,`ticket_order`, `theme_park_id`)  

                        VALUES ('$bdt_user','','$ticket_type','$customer_id','$customer',' $date_of_vist','$aa12','$option','$price','','$adults','$kids','$discount','$total','$timestamp','$ticket_order', $theme_park_id)";
